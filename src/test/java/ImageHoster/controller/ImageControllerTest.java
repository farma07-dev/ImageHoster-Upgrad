...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*@ 1.0.0.1          26-Oct-2020                  Mansur Farooq                  Modification in request parameter in Image Controller for restricting the edit/delete functionality.
*/
...
public class ImageControllerTest {
    ...
    public void editImageWithNonOwnerOfTheImage() throws Exception {
        ...
        /*
        Start: Comments added by Mansur Farooq.Modification in request parameter in Image Controller for restricting the edit/delete functionality.
        ...
        End: Comments added by Mansur Farooq.Modification in request parameter in Image Controller for restricting the edit/delete functionality.
        */
    ...
    public void deleteImageWithNonOwnerOfTheImage() throws Exception {
        ...
        //Start: Added by Mansur Farooq. Modification in request parameter in Image Controller for restricting the edit/delete functionality.
        this.mockMvc.perform(delete("/deleteImage").param("imageId", "1").session(session))
        .andExpect(redirectedUrl("images/"+image.getId()+"/"+image.getTitle()+"?deleteError"));
        //End: Added by Mansur Farooq. Modification in request parameter in Image Controller for restricting the edit/delete functionality.
