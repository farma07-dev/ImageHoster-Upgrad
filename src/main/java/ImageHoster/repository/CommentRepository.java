...
public class CommentRepository {
    ...
    public List<Comments> retrieveComments(Image image){
        ...
        TypedQuery<Comments> typedQuery = null; //Added by Mansur Farooq. Fix for image upload issue.
        try{
        typedQuery = (TypedQuery<Comments>) em.createQuery("SELECT c from Comments c where c.image =:image", Comments.class); //Added by Mansur Farooq. Fix for image upload issue.
