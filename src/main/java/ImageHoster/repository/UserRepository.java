...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
 *@ 1.0.0.1         26-Oct-2020                  Mansur Farooq              Functionality Upgrade: Password validation functionality for Image Hoster Project.
*/
...
public class UserRepository {
    ...
    // Start: Added by Mansur Farooq. Functionality Upgrade: Password validation functionality for Image Hoster Project.
    ...
    // End: Added by Mansur Farooq. Functionality Upgrade: Password validation functionality for Image Hoster Project.
