...
public class Image {
    ...
    @ManyToMany(fetch = FetchType.EAGER)                   //Added by Mansur Farooq. Fix for exception encountered while performing LAZY Loading by the system.
    private List<Tag> tags = new ArrayList<>();

    @OneToMany(fetch = FetchType.EAGER)
    @Fetch(value = FetchMode.SUBSELECT)                    //Added by Mansur Farooq. Fix for exception encountered : "org.hibernate.loader.MultipleBagFetchException: cannot simultaneously fetch multiple bags:"
    private List<Comments> comments = new ArrayList<>();   //Added by Mansur Farooq. Functionality Upgrade: Users can add comments for any image.
    ...
    //Start: Added by Mansur Farooq. Functionality Upgrade: Users can add comments for any image.
    ...
    //End: Added by Mansur Farooq. Functionality Upgrade: Users can add comments for any image.
}
