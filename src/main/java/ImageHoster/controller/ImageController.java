...
public class ImageController {
    ...
    @Autowired
    private CommentService commentService;                            //Added by Mansur Farooq. Functionality Upgrade: Users can add comments for any image.
    ...
    //@RequestMapping("/images/{title}")                         //Comments added by Mansur Farooq. Fix for image upload issue.
    @RequestMapping("/images/{id}/{title}")                      //Added by Mansur Farooq. Fix for image upload issue.
    public String showImage(@PathVariable("id") int id, @PathVariable("title") String title, Model model) {
        //Image image = imageService.getImageByTitle(title);     //Comments added by Mansur Farooq. Fix for image upload issue.
        Image image = imageService.getImageByTitle(title,id);    //Added by Mansur Farooq. Fix for image upload issue.
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
        model.addAttribute("comments",commentService.retrieveComments(image));//Added by Mansur Farooq.Functionality Upgrade: Users can add comments for any image.
        return "images/image";
    }
    ...
    /* Start: Added by Mansur Farooq. Bug Fix: Owner of the image can edit the image.
    @RequestMapping(value = "/editImage")
    public String editImage(@RequestParam("imageId") Integer imageId, Model model) {
       End: Added by Mansur Farooq. Bug Fix: Owner of the image can edit the image.*/
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        //return "redirect:/images/" + updatedImage.getTitle();           //Comments added by Mansur Farooq. Fix for image upload issue.
        return "redirect:/images/"+imageId+"/"+updatedImage.getTitle();   //Added by Mansur Farooq. Fix for image upload issue.
    }
    ...
    /* Start: Comments added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.
    @RequestMapping(value = "/deleteImage", method = RequestMethod.DELETE)
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId) {
      End: Comments added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.*/

    //Start: Added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.
    @RequestMapping(value = "/deleteImage", method = RequestMethod.DELETE)
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, HttpSession session,Model model) {
        //End: Added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.

        //imageService.deleteImage(imageId);      //Comments added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.
        ...
        //return "redirect:/images";             //Comments added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.
        return result;                           //Added by Mansur Farooq. Bug Fix: Owner of the image can delete the image.
    }
